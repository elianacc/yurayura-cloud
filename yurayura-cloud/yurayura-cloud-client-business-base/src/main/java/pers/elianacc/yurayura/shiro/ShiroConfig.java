...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager") DefaultWebSecurityManager securityManager) {
        ...
        filterFactoryBean.setLoginUrl("/api/notAuthentication");
        filterFactoryBean.setUnauthorizedUrl("/api/notAuthorization");
     ...
     *
     * @param
     * @return pers.elianacc.yurayura.system.shiro.UserRealm
     */
    @Bean
